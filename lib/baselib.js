...
if (!input.__handles_kwarg_interpolation__) Object.defineProperties(input, {
    __handles_kwarg_interpolation__ : {value: true}
});
...
if (!clearScreen.__defaults__) Object.defineProperties(clearScreen, {
    ...
    function printAsync() {
        ...
        if (element) {
            addition = sep.join((function() {
                var ρσ_Iter = ρσ_Iterable(args), ρσ_Result = [], arg;
                for (var ρσ_Index = 0; ρσ_Index < ρσ_Iter.length; ρσ_Index++) {
                    arg = ρσ_Iter[ρσ_Index];
                    ρσ_Result.push(arg);
                }
                ρσ_Result = ρσ_list_constructor(ρσ_Result);
                return ρσ_Result;
...
function loadCSS(url_list) {
    var link_elements, urlmedia;
    link_elements = ρσ_list_decorate([]);
